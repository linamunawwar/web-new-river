          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <?php
                ...
                $query_user = "SELECT COUNT(email) AS user FROM user";
              ...
              ?>
              <div class="count"><?php echo $row_user->user; ?></div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <?php
                ...
                $query_post = "SELECT COUNT(isi) AS post FROM post";
                $result_post = $db->query($query_post);
                if(!$result_post){
                  die("Could not query the database: <br />".$db->error);
                }
                $row_post = $result_post->fetch_object();

              ?>
              <div class="count"><?php echo $row_post->post; ?></div>
            </div>
          </div>
          <!-- /top tiles -->
