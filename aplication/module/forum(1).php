...
//---------- action form--------------------
  if(isset($_POST["submit"])){
    ...
    $query2 = "INSERT INTO user (email) VALUES ('$email')  ";
    $result = $db->query($query);
    ...
    echo '<div class="alert alert-success alert-dismissible fade in" role="alert" width="100">
                        ...
                        if ($group != null){
                          ...
                          echo'
                            <form action="?page=Forum" method="POST">
                              ...
                              <input type="hidden" value="'.$id_post.'" name="id_post"></input>
